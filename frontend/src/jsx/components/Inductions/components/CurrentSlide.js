...
const CurrentSlideView =(props)=> {
    ...
    const [SlideContent,setSlideContent] = useState(props.currentSlideContent.slideContent);
    ...
    return(
        ...
        <div dangerouslySetInnerHTML={ createMarkup(props.currentSlideContent.slideContent) } id="slideDataDiv" />
