...
const updatedData = (modelData) =>{
  setUpdateValue(modelData)
   console.log("updated data"+updateValue)
      ...
      if ("status" in response && response.status == true) {
        const rows = response.data.map((row, index) => (
          ...
          <tr key={index}>
            ...
            <td>
            <Dropdown>
				<Dropdown.Toggle as='a'  className="btn-link i-false btn sharp tp-btn-light btn-dark" >
				...
				<Dropdown.Menu className="dropdown-menu dropdown-menu-end" align='right'>
					<Dropdown.Item onClick={() => openModel(row)}>Edit</Dropdown.Item>
  ...
  // api call for update 
  async function updateCompanies(formValues) {
    return fetch("http://localhost:8081/api/company/edit", {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
      ...
      <div className="modal-content" >
        ...
        <div className="modal-body">
          ...
          <form className="comment-form" onSubmit={(e) => { e.preventDefault(); seteditHere(false); }}>
            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="form-group mb-3">
                  ...
                  <input type="text" className="form-control" name="Name" placeholder="Name" value={modelData.name} />
                </div>
              </div>
              <div className="col-lg-6">
                <div className="form-group mb-3">
                  <label htmlFor="email" className="text-black font-w600"> Company ID<span className="required"></span></label>
                  <input type="text" className="form-control" placeholder="companyID" name="Email" value={modelData.companyID}/>
                </div>
              </div>

              <div className="col-lg-6">
              <div className="form-group mb-3">
                <label htmlFor="author" className="text-black font-w600"> Company Email<span className="required">*</span> </label>
                <input type="text" className="form-control" name="company email" placeholder="Email" value={modelData.email}/>
              </div>
            </div>
            <div className="col-lg-6">
              <div className="form-group mb-3">
                <label htmlFor="email" className="text-black font-w600"> Company Password <span className="required">*</span></label>
                <input type="text" className="form-control" placeholder="Password" name="Email" value={modelData.password}/>
              </div>
            </div>
            ...
            <label htmlFor="comment" className="text-black font-w600">Add Company Logo</label>
            ...
            <div className="col-lg-12">
            <div className="form-group mb-3">
              <label htmlFor="comment" className="text-black font-w600">Address</label>
              <textarea rows={2} className="form-control" name="comment" placeholder="add Address" value={modelData.address}/>
            </div>
          </div>
              <div className="col-lg-12">
                <div className="form-group mb-3">
                  <label htmlFor="comment" className="text-black font-w600">About Company</label>
                  <textarea rows={3} className="form-control" name="comment" placeholder="Tell us More" value={modelData.aboutCompany}/>
                </div>
              </div>
              
              <div className="col-lg-12">
                <div className="form-group mb-3">
                  <Button onSubmit={updatedData} type="submit" value="Submit" className="submit btn btn-primary" style={mystyle}>Submit</Button>
